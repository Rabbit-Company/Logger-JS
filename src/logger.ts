...
namespace Logger {
	 ...
	 */
	export let LevelColors: Record<Levels, Colors> = {
	...
	/** Internal storage for NDJson formatted logs. */
	let NDJsonData: string = "";
	 ...
	 * @default false
	 */
	export let NDJson: boolean = false;
	 ...
	 * @default true
	 */
	export let colors: boolean = true;
	 ...
	 * @type {string}
	 */
	export let format: string = "[{date}] {type} {message}";
	 ...
	 */
	export function formatMessage(message: string, logLevel: Levels): string {
	...
	/**
	 * Processes and logs a message based on the specified log level.
	 * If NDJson is enabled, the message is also formatted as NDJson.
	 * @param {*} message - The log message to process.
	 * @param {Levels} logLevel - The log level of the message.
	 */
	function processMessage(message: any, logLevel: Levels): void {
		if (level < logLevel) return;
		message = parseMessage(message);
		if (message === null) return;
		if (NDJson) putNDJson(message, logLevel);
	...
	export function error(message: any): void {
		processMessage(message, Levels.ERROR);
	}
	...
	export function warn(message: any): void {
		processMessage(message, Levels.WARN);
	}
	...
	export function info(message: any): void {
		processMessage(message, Levels.INFO);
	}
	 ...
	 */
	export function http(message: any): void {
		processMessage(message, Levels.HTTP);
	}
	...
	export function verbose(message: any): void {
		processMessage(message, Levels.VERBOSE);
	}
	...
	export function debug(message: any): void {
		processMessage(message, Levels.DEBUG);
	}
	...
	export function silly(message: any): void {
		processMessage(message, Levels.SILLY);
	}
	 ...
	 */
	export function putNDJson(message: string, logLevel: number): void {
	 ...
	 */
	export function getNDJson(): string {
		return NDJsonData ?? "";
	}
	 ...
	 */
	export function resetNDJson(): void {
		NDJsonData = "";
	}
}
